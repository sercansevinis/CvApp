...
<body>
<h2>Update your ${cv.cvLanguage} Cv</h2>
<form:form method="post" action="/update/Cv/${cv.id}" modelAttribute="cv">
	<table>
		<tr>
			<td>FullName</td>
		...
		<tr>
			...
			<td><form:textarea path="projects" rows = "10" cols = "100" maxlength="500"/></td>
